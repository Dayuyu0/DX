...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){
		if($("#tabs").tabs("exists",text)){//若已经存在，只需选中即可
...
<div region="center">
	<div class="easyui-tabs" fit="true" border="false" id="tabs">
		<div title="首页" data-options="iconCls:'icon-home'">
			<div align="center" style="padding-top: 100px"><marquee direction="right" behavior="alternate" scrollamount="13" scrolldelay="0" loop="-1"><font color="red" size="10">欢迎使用</font></marquee></div>
		</div>
	</div>
</div>
